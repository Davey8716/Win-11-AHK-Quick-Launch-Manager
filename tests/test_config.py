from ahk_workspace_manager.config import DEFAULT_AHK_QDIR, AppConfig, ConfigStore, ManagedItem
...
def test_config_round_trip(tmp_path):
    ...
    assert loaded.ahk_qdir_path == "C:/Scripts"
...
def test_config_defaults_ahk_qdir_when_absent(tmp_path):
    path = tmp_path / "config.json"
    path.write_text(
        """
        {
    ...
    assert loaded.ahk_qdir_path == DEFAULT_AHK_QDIR
